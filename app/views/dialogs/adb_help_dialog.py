...
class ADBHelpDialog(QDialog):
    ...
    def get_adb_locations_content(self):
        return """        
        <p><b style="color:#3399DD;">1. Descarga Directa</b>
        ...
        <p><b style="color:#3399DD;">2. Android Studio (Opcional)</b>
        ...
        <p><b style="color:#3399DD;">3. Gestores de Paquetes (Linux)</b>
    ...
    def get_common_paths_content(self):
        return """
        <p><b style="color:#3399DD;">Linux:</b></p> 
        ...
        <p><b style="color:#3399DD;">Windows:</b></p> 
    ...
    def get_setup_instructions_content(self):
        return """
        <p><b style="color:#3399DD;">Opción 1:</b></p> 
        <p style="margin-left:2em;">• En <span style="color:#90caf9; font-weight:bold;">Easy ADB</span>, dentro de la <span style="color:#90caf9; font-weight:bold;">Sección Ajustes</span>, presiona el <span style="color:#90caf9; font-weight:bold;">Botón de Verificar</span> para que la aplicación intente detectar ADB automáticamente.</p>
        ...
        <p><b style="color:#3399DD;">Opción 2:</b></p> 
        <p style="margin-left:2em;">• Descarga SDK Platform Tools desde la página oficial si aún no lo tienes.</p>
        <p style="margin-left:2em;">• En <span style="color:#90caf9; font-weight:bold;">Easy ADB</span>, dentro de la <span style="color:#90caf9; font-weight:bold;">Sección Ajustes</span>, presiona el <span style="color:#90caf9; font-weight:bold;">Botón de Seleccionar</span> y elige manualmente el archivo ejecutable <code>adb</code> dentro de la carpeta correspondiente.</p>
