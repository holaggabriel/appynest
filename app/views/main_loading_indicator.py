...
class MainLoadingIndicator:
    """
    Mixin para agregar funcionalidad de panel de carga con logo y círculo animado.
    """
    
    def setup_loading_panel(self):
        ...
        # Widget personalizado para el logo y animación
        self.loading_widget = LoadingWidget()
        layout.addWidget(self.loading_widget)

        # Al principio mostramos solo el panel de carga
        self.setCentralWidget(self.loading_panel)

    def hide_loading_panel(self):
        if hasattr(self, "loading_panel"):
            self.loading_panel.hide()

    def show_loading_panel(self):
        if hasattr(self, "loading_panel"):
...
class LoadingWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        layout.setAlignment(Qt.AlignmentFlag.AlignCenter)
        layout.setContentsMargins(0, 0, 0, 0)  # Eliminar márgenes del layout
